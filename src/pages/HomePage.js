  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-4 col-md-6 mb-4">
        <div className="card shadow-sm border-0 hover-effect">
          <div className="card-body">
            <h5 className="card-title mb-3 text-primary custom-font">축제 목록 보기</h5>
            <p className="card-text text-muted">다양한 축제 정보를 확인해보세요.</p>
            <Link to="/festivals" className="btn btn-outline-primary mt-3">자세히 보기</Link>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 mb-4">
        <div className="card shadow-sm border-0 hover-effect">
          <div className="card-body">
            <h5 className="card-title mb-3 text-primary custom-font">공지사항 보기</h5>
            <p className="card-text text-muted">최근 공지사항을 확인하세요.</p>
            <Link to="/notices" className="btn btn-outline-primary mt-3">자세히 보기</Link>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-12 mb-4">
        <div className="card shadow-sm border-0 hover-effect">
          <div className="card-body">
            <h5 className="card-title mb-3 text-primary custom-font">축제를 직접 커스터마이징</h5>
            <p className="card-text text-muted">나만의 축제를 만들어보세요!</p>
            <Link to="/customize-festival" className="btn btn-outline-success mt-3">커스터마이징 하기</Link>
          </div>
        </div>
      </div>
    </div>
        ...
        <SwiperSlide key={festival.id}>
          <div className="festival-card shadow-sm rounded overflow-hidden">
            ...
            <div className="card-body p-3">
              <h5 className="card-title text-truncate">{festival.title}</h5>
              <p className="card-text text-muted text-truncate">{festival.description}</p>
              <Link to={`/festivals/${festival.id}`} className="btn btn-outline-primary btn-sm">
                자세히 보기
              </Link>
              <p className="text-danger mt-3 mb-0 fw-bold custom-font">마감까지 D-5</p>
            </div>
          </div>
        </SwiperSlide>
      ))}
